...
public class AlertType {
     ...
     * @throws NullPointerException if <code>display</code> is <code>null</code>
     */
    ...
    /* we don't need a subclass...this private implementation will do. */
