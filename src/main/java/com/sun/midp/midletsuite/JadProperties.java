/*
 * @(#)JadProperties.java	1.15 02/09/24 @(#)
 *
 ...
 * carrage returns and end of file characters are ignored. Third, the key
 * of the property is only checked for whitespace. Fourth, blanklines
 * are allowed so the save code when parsing JAR manfests.
 * <p>
 ...
 * appeneded to the end of the list by default.
 * <p>
